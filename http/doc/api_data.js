define({ "api": [
  ...
  },
  {
    ...
    "name": "PostInbox",
    "group": "Inbox",
    "description": "<p>Create an inbox in the specified mailbox.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "mailbox",
            "description": "<p>ID of the mailbox to add the inbox to.</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>String</p> ",
            "optional": false,
            "field": "title",
            "description": "<p>Title of the new inbox.</p> "
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "EDISABLED",
            "description": "<p>Specified domain has been disabled for registrations.</p> "
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "EOCCUPIED",
            "description": "<p>Address already registered</p> "
          },
          {
            "group": "Error 4xx",
            "optional": false,
  ...
  {
    "type": "post",
    "url": "/mailbox/:mailbox/transferable",
    "title": "Set transferable",
    "version": "0.1.0",
    "name": "setMailboxTransferable",
    "group": "Mailbox",
    "description": "<p>Set the mailbox transferable option, can be set by the creator or a admin.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "mailbox",
            "description": "<p>MailboxID of the mailbox to set.</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>Boolean</p> ",
            "optional": false,
            "field": "transferable",
            "description": "<p>Value to set the mailbox to.</p> "
          }
        ]
      },
      "examples": [
        {
          "title": "Set the mailbox transferable option:",
          "content": "{\n  \"transferable\": \"true\"\n}",
          "type": "json"
        }
      ]
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "transferable",
            "description": "<p>The new transferable boolean.</p> "
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "delete",
    "url": "/user/session/:sid",
    "title": "Destroy session",
    "version": "0.1.0",
    "name": "DeleteSession",
    "group": "Sessions",
    "description": "<p>Destroy a session with the specified id, the session must be yours.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "sid",
            "description": "<p>ID of the session (NOT the token).</p> "
          }
        ]
      },
      "examples": [
        {
          ...
          "content": "/user/session/55e40dc8cf8dbadb0c352305",
          "type": "URI"
        }
      ]
    },
